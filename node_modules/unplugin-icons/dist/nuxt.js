...
var _chunkX6JWFUC3js = require('./chunk-X6JWFUC3.js');
...
function nuxt_default(options = {}, nuxt) {
  ...
  nuxtApp.hook("webpack:config", (configs) => {
    configs.forEach((config) => {
      ...
      config.plugins.unshift(_chunkX6JWFUC3js.src_default.webpack(options));
    });
  });
  nuxtApp.hook("vite:extend", async (vite) => {
    vite.config.plugins = vite.config.plugins || [];
    vite.config.plugins.push(_chunkX6JWFUC3js.src_default.vite(options));
  });
}
